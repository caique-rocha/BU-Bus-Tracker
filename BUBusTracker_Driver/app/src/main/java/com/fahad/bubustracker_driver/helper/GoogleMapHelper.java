...
import com.fahad.bubustracker_driver.R;
...
public class GoogleMapHelper {
    ...
    public MarkerOptions getDriverMarkerOptions(String driverId, Location position) {
        MarkerOptions options = getMarkerOptions(driverId, new LatLng(position.getLatitude(),position.getLongitude()));
        options.flat(true);
        return options;
    }
