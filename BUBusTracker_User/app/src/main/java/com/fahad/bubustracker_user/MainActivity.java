package com.fahad.bubustracker_user;
...
import com.fahad.bubustracker_user.collection.MarkerCollection;
import com.fahad.bubustracker_user.helpers.FirebaseEventListenerHelper;
import com.fahad.bubustracker_user.helpers.GoogleMapHelper;
import com.fahad.bubustracker_user.helpers.MarkerAnimationHelper;
import com.fahad.bubustracker_user.helpers.UiHelper;
import com.fahad.bubustracker_user.interfaces.FirebaseDriverListener;
import com.fahad.bubustracker_user.interfaces.LatLngInterpolator;
...
public class MainActivity extends AppCompatActivity implements FirebaseDriverListener {
    ...
    public void onDriverAdded(Driver driver) {
        MarkerOptions markerOptions = googleMapHelper.getDriverMarkerOptions(driver.getDriverId(),new LatLng(driver.getLat(), driver.getLng()));
